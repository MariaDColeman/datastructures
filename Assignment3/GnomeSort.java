/**
 * A really messed-up sorting algorithm.
 *
 * See https://en.wikipedia.org/wiki/Gnome_sort for more. Note, however, that
 * Gnome Sort is <b>not</b> official course material. It's entertainment! :-)
 *
