 ...
 *
 * Keys must be unique, not null, and immutable; values have no constraints. We
 * use Java's IllegalArgumentException instead of our own, mostly to show you
 * yet another style of interface design.
 *
 * Maps are *very* popular abstractions. Some programming languages, Go and
 * Python for example, have them "built in" directly. Maps are also known as
 * "dictionaries" or "associative arrays" in other contexts.
 *
