...
#
# it will generate 100 numbers, each between 1 and 10000, with roughly 50%
# repeated numbers. The existing test data we hand you was generated as
# follows:
#
...
#
# You need to create your own test data with different properties, see the
# description on the assignment handout.
