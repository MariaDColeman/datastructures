 ...
 */
public class TreapMapToTest<K extends Comparable<? super K>, V>
    ...
    private class Node {
        ...
        Node(K k, V v) {
            ...
            this.key = k;
            this.value = v;
//            this.priority = TreapMapToTest.this.random.nextInt();
            this.priority = TreapMapToTest.this.testArray[TreapMapToTest.this.testRandom];
            //TreapMapToTest.this.testRandom++;
        }
    ...
    //testArray[5] = 1;
    //testArray[6] = 7;
    int[] testArray = {3, 0, 7, 2, 9, 1, 7};
    private int testRandom = -1;
    @Override
    public int size() {
        return this.size;
    }
